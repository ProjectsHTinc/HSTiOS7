...
//  SPV
//
//  Created by Happy Sanz Tech on 29/10/20.
...
class News: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        data = ["All","Local News","State News"]
        setUpSegementControl()
        self.callAPI(from: "news", search_text: "no", categoery: "all", nf_category_id: "0" ,offset: "0", rowcount: "50")
    ...
    @objc func segmentedControlChangedValue(segmentedControl: HMSegmentedControl){
        if segmentedControl.selectedSegmentIndex == 0 {
            ...
            self.callAPI(from: "news", search_text: "no", categoery: "Local News", nf_category_id: GlobalVariables.shared.localNewsId ,offset: "0", rowcount: "50")

        }
        else if segmentedControl.selectedSegmentIndex == 2 {
            self.callAPI(from: "news", search_text: "no", categoery: "State News", nf_category_id: GlobalVariables.shared.stateNewsId ,offset: "0", rowcount: "50")
...
extension News: HomeView, UITableViewDelegate, UITableViewDataSource
{
    func startLoading() {
             ...
             if indexPath.row == lastElement
             {
                  ...
                  if segmentedControl.selectedSegmentIndex == 0 {
                     self.callAPI(from: "news", search_text: "no", categoery: "all", nf_category_id: "0" ,offset: "0", rowcount: "50")
                       ...
                       self.callAPI(from: "news", search_text: "no", categoery: "Local News", nf_category_id: GlobalVariables.shared.localNewsId ,offset: String(lE), rowcount: "50")
                  }
                  else if segmentedControl.selectedSegmentIndex == 2 {
                       self.callAPI(from: "news", search_text: "no", categoery: "State News", nf_category_id: GlobalVariables.shared.stateNewsId ,offset: String(lE), rowcount: "50")
                  }
             }
        }
    }
